...
And ('I do the registration for my user by entering username as {string} and email address as {string} and password as {string}',
...
And ('I do the assertions for Register Button and Register successfully by entering new password as {string}',
    (NewPassword) => {
...
Then ('I do the verification on the Cart Page that it contains {string} and {string} and do the checkout successfully' ,
...
And ('I do the login with same credentials used above {string} and {string}',
  (Email , Password) => {
